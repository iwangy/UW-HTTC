        ...
        <Container>
          ...
          <Row className={[contactStyles.info, "justify-content-center pt-3"].join(' ')}>
            <Col sm={12} md={10} className={["justify-content-center  d-flex"].join(' ')}>
              ...
              <a href="https://www.flowcode.com/page/huskytabletennisclub" target="_blank" rel="noopener noreferrer">
                <img src={link} fluid="true" alt="facebook" />
                <p>/flowcode</p>
              </a>
            </Col>
            <Col sm={8} md={10} className="mt-3">
              <Button className={contactStyles.button} target="_blank" size="lg" variant="light" href="">DONATE TO OUR CLUB</Button>
            </Col>
          </Row>
        </Container>
      </div>
